...
/** Ported verbatim from the design lab (app/[locale]/security/page.tsx), bilingual via {dict, locale}. */
export function SecurityView({ dict, locale }: { dict: Dictionary; locale: Locale }) {
