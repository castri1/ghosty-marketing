...
/** Ported verbatim from the design lab (app/[locale]/compare/vercel/page.tsx), bilingual via {dict, locale}. */
export function CompareVercelView({ dict, locale }: { dict: Dictionary; locale: Locale }) {
  const t = dict.compareVercel;
            ...
            <div className="mt-16 grid gap-6 md:grid-cols-2">
              <Rise>
                <article className="h-full border border-line bg-surface p-8 sm:p-10">
                  <span className="px-label text-muted">{t.choice.vercelLabel}</span>
