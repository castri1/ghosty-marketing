...
/** Ported verbatim from the design lab (app/[locale]/compare/page.tsx), bilingual via {dict, locale}. */
export function CompareHubView({ dict, locale }: { dict: Dictionary; locale: Locale }) {
  const t = dict.compareHub;
