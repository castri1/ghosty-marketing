...
export const metadata: Metadata = pageMeta({
  title: copy.meta.pricing.title,
  description: copy.meta.pricing.description,
  path: '/pricing',
});
 ...
 * in `lib/wg-copy.ts`; the internal economics annexe never lands here.
 */
...
function TierCard({
  ...
  tier: (typeof copy.pricing.tiers)[number];
  locale: 'en';
  popularLabel?: string;
}) {
