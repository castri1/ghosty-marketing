...
export const metadata: Metadata = pageMeta({
  title: copy.meta.compareVercel.title,
  description: copy.meta.compareVercel.description,
  path: '/compare/vercel',
});
...
/** Ported verbatim from the design lab (app/[locale]/compare/vercel/page.tsx), English-only. */
export default function CompareVercelPage() {
  const locale = 'en' as const;
  const t = copy.compareVercel;
