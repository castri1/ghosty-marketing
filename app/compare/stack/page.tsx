...
export const metadata: Metadata = pageMeta({
  title: copy.meta.compareStack.title,
  description: copy.meta.compareStack.description,
  path: '/compare/stack',
});
...
/** Ported verbatim from the design lab (app/[locale]/compare/stack/page.tsx), English-only. */
export default function CompareStackPage() {
  const locale = 'en' as const;
  const t = copy.compareStack;
