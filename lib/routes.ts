...
export const ROUTES: SiteRoute[] = [
  ...
  { path: '/deploy/claude-code', llms: 'How to deploy an app built with Claude Code', es: '/es/publicar/claude-code', llmsEs: 'Cómo publicar una app hecha con Claude Code' },
  { path: '/deploy/codex', llms: 'How to deploy an app built with Codex', es: '/es/publicar/codex', llmsEs: 'Cómo publicar una app hecha con Codex' },
  { path: '/docs', llms: 'Docs' },
