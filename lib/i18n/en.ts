/**
 * English dictionary: the site copy, ported VERBATIM from the design lab
 * (~/AI/White Ghost/lib/i18n/en.ts) and extended since (pricing v2, consent).
 * This file defines the dictionary SHAPE; `es.ts` is typed against it so any
